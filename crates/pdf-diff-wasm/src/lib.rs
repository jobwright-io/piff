...
use pdf_diff_pdfium::{
    ...
    render_page_diff_png_with_passwords_and_cancellation, PageMatching, PdfDiffError, PdfDiffMode,
    PdfDiffOptions, PdfPasswords, PdfRenderRequest, PdfResourceLimits, PreviewView,
};
...
fn parse_options(
    options_json: Option<String>,
) -> Result<(PdfDiffOptions, PasswordsOwned), JsValue> {
...
fn error_value(error: PdfDiffError) -> JsValue {

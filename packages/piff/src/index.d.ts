import type { PiffOptions, PiffRunOptions, PdfPagePreviewOptions, PiffResult } from './types.js';
...
export declare class PiffSession {
    ...
    private equality;
    private constructor();
    static open(before: Uint8Array, after: Uint8Array, options?: PiffOptions): Promise<PiffSession>;
